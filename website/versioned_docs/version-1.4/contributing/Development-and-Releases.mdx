...
6. Publish a GitHub release with both built artifacts: `bukkit/build/libs/doubledoors-bukkit-<version>.jar` and `velocity/build/libs/doubledoors-velocity-<version>.jar`.
