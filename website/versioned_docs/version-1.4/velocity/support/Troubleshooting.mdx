...
id: velocity-support-troubleshooting
slug: /velocity/support/troubleshooting
---
...
Each backend operates independently. The Velocity plugin does not synchronize door blocks across backend servers. Install the Bukkit plugin on each backend and use backend-specific configuration.
